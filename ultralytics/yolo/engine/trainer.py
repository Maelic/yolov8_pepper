        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                if rank in (-1, 0):
                    ...
                    if self.args.wandb:
                        wandb.log({'box_loss': losses[0], 'cls_loss': losses[1], 'dfl_loss': losses[2]}, step=ni)
            ...
            if rank in (-1, 0):
                ...
                if self.args.wandb:
                    wandb.log({'mAP50': self.metrics['metrics/mAP50(B)'], 'mAP50-95': self.metrics['metrics/mAP50-95(B)']}, step=ni)
